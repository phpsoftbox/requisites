...
final class RequisitesMigrateHandler implements HandlerInterface
{
    ...
    public function run(RunnerInterface $runner): int|Response
    {
        ...
        $runner->io()->writeln('Профиль: ' . $report->profile);
        $runner->io()->writeln('Storage: ' . $report->storageDriver);
        $runner->io()->writeln('Подключение: ' . $report->connection);
        $runner->io()->writeln('Таблица: ' . $report->table);
