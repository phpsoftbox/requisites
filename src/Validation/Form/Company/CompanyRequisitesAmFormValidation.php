...
final class CompanyRequisitesAmFormValidation extends AbstractRequisitesFormValidation
{
    ...
    public static function rulesDefinition(): array
    {
        return [
            'country_code' => [
                new StringValidation()->required()->in('AM'),
            ],
            'organization_type' => [
            ...
            'bank_account_number' => [
                new StringValidation()->required()->regex('/^[A-Z0-9]{3,34}$/'),
            ],
        ];
    }
