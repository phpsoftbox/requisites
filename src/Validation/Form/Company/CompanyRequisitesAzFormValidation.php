...
use PhpSoftBox\Requisites\Validation\Rule\Az\IbanFormatValidation;
...
final class CompanyRequisitesAzFormValidation extends AbstractRequisitesFormValidation
{
    ...
    public static function rulesDefinition(): array
    {
        return [
            'country_code' => [
                new StringValidation()->required()->in('AZ'),
            ],
            'organization_type' => [
