...
use PhpSoftBox\Requisites\Validation\Rule\Kz\IbanFormatValidation;
...
final class CompanyRequisitesKzFormValidation extends AbstractRequisitesFormValidation
{
    ...
    public static function rulesDefinition(): array
    {
        return [
            'country_code' => [
                new StringValidation()->required()->in('KZ'),
            ],
            'organization_type' => [
            ...
            'organization_inn' => [
                new StringValidation()->required()->regex('/^\d{12}$/'),
                new BinIinChecksumValidation(),
            ],
