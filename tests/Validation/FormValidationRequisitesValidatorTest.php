...
final class FormValidationRequisitesValidatorTest extends TestCase
{
    ...
    #[Test]
    public function strictModeRejectsMissingForm(): void
    {
        $validator = new FormValidationRequisitesValidator([], strict: true);

        $this->expectException(MissingProfileValidatorException::class);
        $validator->validate('company', 'default', ['name' => 'Acme']);
    }
}
